...
[
        ...
        "simpleTableColumns": [
          {
            ...
            "selectItems": [
              ...
              {
                "value": "event_time",
                "displayValue": "Event Time (Unix timestamp or ISO_8601 format)"
              },
              {
  ...
  {
    "displayName": "Event Details Parameters",
    "name": "eventDetailsParametersListGroup",
    "groupStyle": "ZIPPY_OPEN_ON_PARAM",
    "type": "GROUP",
    "subParams": [
      {
        "type": "SELECT",
        "name": "eventDetailsParametersObject",
        "displayName": "Event Details Parameters Object",
        "macrosInSelect": true,
        "selectItems": [],
        "simpleValueType": true,
        "help": "Provide an object with Event Details Parameters to merge with the parameters below. Any conflicting parameters will be overwritten.",
        "notSetText": "(not set)"
      },
      {
        "type": "LABEL",
  ...
  },
  {
    ...
    "subParams": [
      {
        "type": "SELECT",
        "name": "generateDeviceIdCookie",
        "displayName": "Generate Device ID cookie (Web only)",
        "macrosInSelect": true,
        "selectItems": [
          {
            "value": false,
        ...
        "simpleValueType": true,
        "help": "If no Device ID is set in the User Data parameters section:\n\u003cul\u003e\u003cli\u003eUse the Device ID from Spotify JS SDK \u003ci\u003e__spdt\u003c/i\u003e or \u003ci\u003e__pdst\u003c/i\u003e, if any of the cookies exist\u003c/li\u003e\n\u003cli\u003eor, if the cookies don\u0027t exist, generate a new Device ID value and save it in the cookie \u003ci\u003e__spdt\u003c/i\u003e\u003c/li\u003e\n\u003c/ul\u003e",
        "subParams": [
          {
            "type": "GROUP",
            ...
            "enablingConditions": [
              {
                "paramName": "generateDeviceIdCookie",
                "paramValue": false,
                "type": "NOT_EQUALS"
              }
            ]
      ...
      },
      {
        ...
        "selectItems": [],
        "simpleValueType": true,
        "help": "Provide an object with User Data to merge with the parameters below. Any conflicting parameters will be overwritten.",
        "notSetText": "(not set)"
      },
      {
        "type": "LABEL",
        ...
        "simpleTableColumns": [
          {
            ...
            "selectItems": [
              ...
              {
                "value": "hashed_emails",
                "displayValue": "Email (array or single item - if not SHA256 hashed, it will be automatically hashed)"
              },
              {
                "value": "hashed_phone_number",
                "displayValue": "Phone Number (single item - if not SHA256 hashed, it will be automatically hashed)"
              }
            ]
          },
          {
        ...
        },
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://capi.spotify.com/capi-direct/events/"
              },
              {
                "type": 1,
...
- name: Device ID cookie is NOT set and not used when the option is not active
  code: |-
    ...
    mockData.generateDeviceIdCookie = undefined;

    mock('sendHttpRequest', (requestUrl, callback, requestOptions, requestBody) => {
      const parsedRequestBody = JSON.parse(requestBody);
      assertThat(parsedRequestBody.conversion_events.events[0].user_data.device_id).isEqualTo(expectedDeviceId);
      callback(200);
    });
...
- name: Request is successfully built and sent - Data from UI fields
  code: |-
    ...
    const expectedRequestUrl = 'https://capi.spotify.com/capi-direct/events/';
    mock('sendHttpRequest', (requestUrl, callback, requestOptions, requestBody) => {
          ...
          events: [
            {
              ...
              event_time: '2025-05-27T18:06:52.323Z',
              action_source: 'WEB',
              opt_out_targeting: true,
              event_id: 'foobar',
          ...
          events: [
            {
              ...
              event_time: '2025-05-27T20:16:56.000Z',
              action_source: 'WEB',
              event_source_url: 'https://example.com/?test=1i23i21j3',
              event_details: { amount: 123.45, currency: 'BRL' },
              user_data: {
                hashed_emails: [
                ...
                hashed_phone_number:
                  'c698c0b85d32cbcf5033ada58f34de87d4f7415efaf5a8d1c1e9e63393dcc85e',
                ip_address: '2804:14d:c096:8dd6:311c:8c00:e6c:e33'
              }
            }
          ]
        }
